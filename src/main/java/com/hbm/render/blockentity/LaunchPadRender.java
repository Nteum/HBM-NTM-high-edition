...
public class LaunchPadRender implements BlockEntityRenderer<LaunchPadTileEntityBE> {
    ...
    @Override
    public void render(LaunchPadTileEntityBE pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        pPoseStack.pushPose();
