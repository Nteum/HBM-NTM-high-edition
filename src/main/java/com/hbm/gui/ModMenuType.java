...
public class ModMenuType {
    ...
    public static final RegistryObject<MenuType<MenuWoodBurner>> MENU_WOOD_BURNER =
            MOD_MENU_TYPES.register("menu_wood_burner",()->IForgeMenuType.create(MenuWoodBurner::new));
}
