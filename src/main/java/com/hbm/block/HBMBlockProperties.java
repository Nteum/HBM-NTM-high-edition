...
public class HBMBlockProperties {
    ...
    public static final IntegerProperty VARIANT5 = IntegerProperty.create("variant5", 0, 4);
    public static final IntegerProperty VARIANT8 = IntegerProperty.create("variant8", 0, 7);
    // 相对方向，指某个面相对于已知面的方向
