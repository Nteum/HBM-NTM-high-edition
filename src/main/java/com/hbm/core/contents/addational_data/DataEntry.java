...
import com.hbm.core.contents.addational_data.entity.living.ContaminationEffectLists;
import com.hbm.core.contents.addational_data.entity.player.RightClickCount;
...
public enum DataEntry {
    ...
    DIGAMMA(Float.class),
    GRAVITY(Boolean.class, true, true, true),
