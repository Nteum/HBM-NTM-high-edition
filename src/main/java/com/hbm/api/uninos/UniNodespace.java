...
//
///** 所有网络的总控
// * 节点 --> 网络net --> 网络空间nodespace --> 服务器事件函数serverTick
// * - nodespace功能：
// * 1. 运行每个网络，让每个网络传输其能源
// * 2. 定期更新网络，检查有没有新的节点加入
// * - 数据结构
// * 1. map<World,list<Net>> netMap - 记录所有网络
// * 2. set<Net> activeNets - 记录所有可更新的网络
// * */
