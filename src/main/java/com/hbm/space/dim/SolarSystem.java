...
import com.hbm.space.dim.dres.WorldGenDres;
import com.hbm.space.dim.duna.WorldGenDuna;
import com.hbm.space.dim.eve.WorldGenEve;
import com.hbm.space.dim.ike.WorldGenIke;
import com.hbm.space.dim.laythe.WorldGenLaythe;
import com.hbm.space.dim.minmus.WorldGenMinmus;
import com.hbm.space.dim.moho.WorldGenMoho;
import com.hbm.space.dim.moon.WorldGenMun;
import com.hbm.space.dim.orbit.Space;
import com.hbm.space.dim.tekto.WorldGenTekto;
import com.hbm.space.dim.trait.CBT_Atmosphere;
import com.hbm.space.dim.trait.CBT_Temperature;
...
public class SolarSystem {
	...
	public static void init() {
		...
		kerbol = new CelestialBody("kerbol")
			...
			.withShader(HBM.rl("shaders/blackhole.frag"), 3) // Only shows when CBT_Destroyed
			.withSatellites(

				new CelestialBody("moho", WorldGenMoho.KEY_LEVEL, Body.MOHO)
					...
					.withBlockTextures(HBM.MODID + ":textures/blocks/moho_stone.png", HBM.MODID + ":textures/blocks/moho_regolith.png")
					.withAxialTilt(30F)
					.withTraits(new CBT_Temperature(200)),

				new CelestialBody("eve", WorldGenEve.KEY_LEVEL, Body.EVE)
					...
					.withBlockTextures(HBM.MODID + ":textures/blocks/eve_stone_2.png", HBM.MODID + ":textures/blocks/eve_silt.png")
					.withMinProcessingLevel(2)
					.withTraits(new CBT_Atmosphere(HBMFluids.EVEAIR.source().get(), 5D), new CBT_Temperature(400), new CBT_Water(HBMFluids.MERCURY.source().get()))
					.withSatellites(
				...
				new CelestialBody("kerbin", Level.OVERWORLD, Body.KERBIN) // overworld
					...
					.withTraits(new CBT_Atmosphere(HBMFluids.EARTHAIR.source().get(), 1D), new CBT_Water())
					.withBlockTextures("textures/blocks/stone.png", "textures/blocks/dirt.png")
					.withCityMask(HBM.rl("textures/misc/space/kerbin_mask.png"))
					.withBiomeMask(HBM.rl("textures/misc/space/kerbin_biomes.png"))
					.withSatellites(

						new CelestialBody("mun", WorldGenMun.KEY_LEVEL, Body.MUN)
							...
							.withBlockTextures(HBM.MODID + ":textures/blocks/moon_rock.png", HBM.MODID + ":textures/blocks/moon_turf.png")
							.withIce(true),

						new CelestialBody("minmus", WorldGenMinmus.KEY_LEVEL, Body.MINMUS)
							...
							.withBlockTextures(HBM.MODID + ":textures/blocks/minmus_stone.png", HBM.MODID + ":textures/blocks/minmus_regolith.png")
							.withTraits(new CBT_Water(HBMFluids.MILK.source().get()))
							.withIce(true)

					),

				new CelestialBody("duna", WorldGenDuna.KEY_LEVEL, Body.DUNA)
					...
					.withBlockTextures(HBM.MODID + ":textures/blocks/duna_rock.png", HBM.MODID + ":textures/blocks/duna_sands.png")
					.withTraits(new CBT_Atmosphere(HBMFluids.DUNAAIR.source().get(), 0.1D))
					.withCityMask(HBM.rl("textures/misc/space/duna_mask.png"))
					.withIce(true)
					.withSatellites(

						new CelestialBody("ike", WorldGenIke.KEY_LEVEL, Body.IKE)
							.withMassRadius(2.782e20F, 130)
							.withOrbitalParameters(3_200, 0.03F, 0.0F, 0.2F, 0.0F)
							.withBlockTextures(HBM.MODID + ":textures/blocks/ike_stone.png", HBM.MODID + ":textures/blocks/ike_regolith.png")
							.withRotationalPeriod(65_518)
							.withTidalLockingTo("duna")
							.withColor(0.533F, 0.502F, 0.526F)
							.withTraits(new CBT_Water(HBMFluids.BROMINE.source().get()))
							.withIce(true)

					),

				new CelestialBody("dres", WorldGenDres.KEY_LEVEL, Body.DRES)
					...
					.withBlockTextures(HBM.MODID + ":textures/blocks/dresbase.png", HBM.MODID + ":textures/blocks/sellafield_slaked.png")
				...
				new CelestialBody("jool")
					...
					.withGas(HBMFluids.JOOLGAS.source().get())
					.withSatellites(

						new CelestialBody("laythe", WorldGenLaythe.KEY_LEVEL, Body.LAYTHE)
							...
							.withTraits(new CBT_Atmosphere(HBMFluids.EARTHAIR.source().get(), 0.45D).and(HBMFluids.XENON.source().get(), 0.15D), new CBT_Water())
							.withBlockTextures("textures/blocks/stone.png", HBM.MODID + ":textures/blocks/laythe_silt.png")
							.withCityMask(HBM.rl("textures/misc/space/laythe_mask.png")),
				...
				new CelestialBody("sarnus")
					...
					.withGas(HBMFluids.SARNUSGAS.source().get())
					.withSatellites(
					...
					new CelestialBody("tekto", WorldGenTekto.KEY_LEVEL, Body.TEKTO)
						...
						.withAxialTilt(25F)
						.withMinProcessingLevel(3)
						.withTraits(new CBT_Atmosphere(HBMFluids.TEKTOAIR.source().get(), 1.5F), new CBT_Water(HBMFluids.CCL.source().get())) // :)
						.withBlockTextures(HBM.MODID + ":textures/blocks/basalt.png", HBM.MODID + ":textures/blocks/rubber_silt.png")
				...
				new CelestialBody("urlum")
					...
					.withGas(HBMFluids.UGAS.source().get())
					.withSatellites(
				...
				new CelestialBody("neidon")
					...
					.withGas(HBMFluids.NGAS.source().get())
					.withSatellites(
					...
					new CelestialBody("thatmo")
						...
						.withTraits(new CBT_Atmosphere(HBMFluids.NITROGEN.source().get(), 0.005F), new CelestialBodyTrait.CBT_BATTLEFIELD())
						.withIce(true),
	...
	public enum Body {
		...
		public ResourceKey<Level> getDimensionId() {
			if(this == ORBIT) return Space.LEVEL_KEY;
			return getBody().dimension;
		}
	}
	...
	public static List<OrreryMetric> calculatePositionsOrrery(Level world, float partialTicks) {
		List<OrreryMetric> metrics = new ArrayList<OrreryMetric>();

		double ticks = ((double)world.getGameTime() + partialTicks) * (double) AstronomyUtil.TIME_MULTIPLIER;
	...
	public static List<AstroMetric> calculateMetricsFromBody(Level world, float partialTicks, CelestialBody body, float solarAngle) {
	...
	public static List<AstroMetric> calculateMetricsFromSatellite(Level world, float partialTicks, CelestialBody orbiting, double altitude) {
		List<AstroMetric> metrics = new ArrayList<AstroMetric>();
	...
	public static List<AstroMetric> calculateMetricsBetweenSatelliteOrbits(Level world, float partialTicks, CelestialBody from, CelestialBody to, double fromAltitude, double toAltitude, double t) {
		List<AstroMetric> metrics = new ArrayList<AstroMetric>();
	...
	public static double calculateDistanceBetweenTwoBodies(Level world, CelestialBody from, CelestialBody to) {
		List<AstroMetric> metrics = new ArrayList<AstroMetric>();

		double ticks = (double)world.getGameTime() * (double)AstronomyUtil.TIME_MULTIPLIER;

		// Get our XYZ coordinates of all bodies
		calculatePositionsRecursive(metrics, null, from.getStar(), ticks);

		Vec3 fromPos = new Vec3(0, 0, 0);
		Vec3 toPos = new Vec3(0, 0, 0);
		for(AstroMetric metric : metrics) {
	...
	private static Vec3 lerp(Vec3 from, Vec3 to, double t) {
		double x = Mth.clampedLerp(from.x, to.x, t);
		double y = Mth.clampedLerp(from.y, to.y, t);
		double z = Mth.clampedLerp(from.z, to.z, t);
	...
	private static void calculatePositionsRecursive(List<AstroMetric> metrics, AstroMetric parentMetric, CelestialBody body, double ticks, CelestialBody lockBody, double solarAngle, double rotOffset) {
		Vec3 parentPosition = parentMetric != null ? parentMetric.position : new Vec3(0, 0, 0);
	...
	private static void calculatePositionsRecursiveOrrery(List<OrreryMetric> metrics, OrreryMetric parentMetric, CelestialBody body, double ticks, int depth) {
		...
		for(CelestialBody satellite : body.satellites) {
			double extraDistance = Mth.clamp(satellite.radiusKm, ORRERY_MIN_RADIUS, ORRERY_MAX_RADIUS) * ((1 + satellite.eccentricity) * 2) * 1.42;
			for(CelestialBody inner : satellite.satellites) {
				extraDistance += Mth.clamp(inner.radiusKm, ORRERY_MIN_RADIUS, ORRERY_MAX_RADIUS) * ((1 + inner.eccentricity) * 2) * 2;
			}
	...
	private static double getApparentAngleDegrees(Vec3 from, Vec3 to) {
		...
		return Mth.wrapDegrees(Math.toDegrees(angleToOrigin - angleToTarget));
	}
	...
	private static double getApparentInclinationDegrees(Vec3 from, Vec3 to) {
		...
		return Mth.wrapDegrees(Math.toDegrees(Math.atan2(offsetDistance, planeDistance)));
	}
	...
	public static double calculateSingleAngle(Level world, double partialTicks, List<AstroMetric> metrics, CelestialBody orbiting, double altitude) {
		double ticks = ((double)world.getGameTime() + partialTicks) * (double)AstronomyUtil.TIME_MULTIPLIER;
	...
	public static double calculateSingleAngle(Level world, CelestialBody from, CelestialBody to) {
		List<AstroMetric> metrics = new ArrayList<AstroMetric>();
	...
	public static double calculateSiderealAngle(Level world, float partialTicks, CelestialBody body) {
		double ticks = ((double)world.getGameTime() + partialTicks) * (double)AstronomyUtil.TIME_MULTIPLIER;
	...
	public static int getFuelCost(double deltaV, int mass, int isp) {
		...
		return propellantVolume + 100 > Integer.MAX_VALUE ? Integer.MAX_VALUE : Mth.ceil(propellantVolume * 0.01D) * 100;
	}
	...
	public static void runTests() {
		...
		HBM.LOGGER.info("Kerbin launch cost: " + getLiftoffDeltaV(kerbin, deltaIVMass, RD180RocketThrust, 0));
		HBM.LOGGER.info("Eve launch cost: " + getLiftoffDeltaV(eve, deltaIVMass, RD180RocketThrust, 0));
		HBM.LOGGER.info("Duna launch cost: " + getLiftoffDeltaV(duna, deltaIVMass, RD180RocketThrust, 0));
		HBM.LOGGER.info("Mun launch cost: " + getLiftoffDeltaV(mun, deltaIVMass, RD180RocketThrust, 0));
		HBM.LOGGER.info("Minmus launch cost: " + getLiftoffDeltaV(minmus, deltaIVMass, RD180RocketThrust, 0));
		HBM.LOGGER.info("Ike launch cost: " + getLiftoffDeltaV(ike, deltaIVMass, RD180RocketThrust, 0));

		HBM.LOGGER.info("Kerbin -> Eve cost: " + getDeltaVBetween(kerbin, eve) + " - should be: " + (950+90+80+1330));
		HBM.LOGGER.info("Kerbin -> Duna cost: " + getDeltaVBetween(kerbin, duna) + " - should be: " + (950+130+250+360));
		HBM.LOGGER.info("Kerbin -> Ike cost: " + getDeltaVBetween(kerbin, ike) + " - should be: " + (950+130+250+30+180));
		HBM.LOGGER.info("Eve -> Duna cost: " + getDeltaVBetween(eve, duna));
		HBM.LOGGER.info("Kerbin -> Mun cost: " + getDeltaVBetween(kerbin, mun) + " - should be: " + (860+310));
		HBM.LOGGER.info("Kerbin -> Minmus cost: " + getDeltaVBetween(kerbin, minmus) + " - should be: " + (930+160));
		HBM.LOGGER.info("Mun -> Kerbin cost: " + getDeltaVBetween(mun, kerbin) + " - should be: " + (860+310));
		HBM.LOGGER.info("Minmus -> Kerbin cost: " + getDeltaVBetween(minmus, kerbin) + " - should be: " + (930+160));
		HBM.LOGGER.info("Minmus -> Ike cost: " + getDeltaVBetween(minmus, ike));

		HBM.LOGGER.info("Kerbin orbital period: " + kerbin.getOrbitalPeriod() + " - should be: " + 426);
		HBM.LOGGER.info("Eve orbital period: " + eve.getOrbitalPeriod() + " - should be: " + 261);
		HBM.LOGGER.info("Mun orbital period: " + mun.getOrbitalPeriod() + " - should be: " + 6);

//		TODO - TileEntityDysonReceiver.runTests();
	}
