...
public class ModFluids {
    ...
    // FluidType
    public static final ExtendedFluidType irradiated_water = new ExtendedFluidType(HBM.rl("block/fluid/irradiated_water_still"),HBM.rl("block/fluid/irradiated_water_flow"),WATER_OVERLAY,0xA1E038D0,new Vector3f(224f / 255f, 56f / 255f, 208f / 255f), prop_water, ExtendedProperties.of());
    public static final ExtendedFluidType irradiated_polluted = new ExtendedFluidType(HBM.rl("block/fluid/irradiated_polluted_still"),HBM.rl("block/fluid/irradiated_polluted_flow"),WATER_OVERLAY,0xA1E038D0,new Vector3f(224f / 255f, 56f / 255f, 208f / 255f), prop_water, ExtendedProperties.of());
    public static final ExtendedFluidType sulfuric_acid = new ExtendedFluidType(0xB0AA64, prop_water, ExtendedProperties.of().pfr(3,0,2).traits(new FT_Corrosive(50), LIQUID));
...
//    public static final ExtendedFluidType COOLANT = new ExtendedFluidType(0xd8fcff, prop_water, ExtendedProperties.of().pfr(1).traits(LIQUID));
    ...
    public static final FluidRegistryHolder<ExtendedFluidType, ForgeFlowingFluid.Source, ForgeFlowingFluid.Flowing,LiquidBlock, BucketItem> IRRADIATED_WATER = register("irradiated_water",irradiated_water);
    public static final FluidRegistryHolder<ExtendedFluidType, ForgeFlowingFluid.Source, ForgeFlowingFluid.Flowing,LiquidBlock, BucketItem> IRRADIATED_POLLUTED = register("irradiated_polluted",irradiated_polluted);
    public static final FluidRegistryHolder<ExtendedFluidType, ForgeFlowingFluid.Source, ForgeFlowingFluid.Flowing,LiquidBlock, BucketItem> SULFURIC_ACID = register("sulfuric_acid",sulfuric_acid);
    ...
    public static FluidRegistryHolder register(String name, ExtendedFluidType fluidType){
        ...
        RegistryObject<BucketItem> bucket = FLUID_CONTAINER.register("bucket_" + name, () -> new BucketItem(source, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
