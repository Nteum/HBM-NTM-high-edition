...
public class ModFluids {
    ...
    private static final ExtendedFluidType irradiated_water = new ExtendedFluidType("irradiated_water",HBM.rl("block/fluid/irradiated_water_still"),HBM.rl("block/fluid/irradiated_water_flow"),WATER_OVERLAY,0xA1E038D0,new Vector3f(224f / 255f, 56f / 255f, 208f / 255f), prop_water.descriptionId("Radioactive Water"), ExtendedProperties.of());
    private static final ExtendedFluidType irradiated_polluted = new ExtendedFluidType("irradiated_polluted",HBM.rl("block/fluid/irradiated_polluted_still"),HBM.rl("block/fluid/irradiated_polluted_flow"),WATER_OVERLAY,0xA1E038D0,new Vector3f(224f / 255f, 56f / 255f, 208f / 255f), prop_water.descriptionId("Nuclear-contaminated Water"), ExtendedProperties.of());
    private static final ExtendedFluidType sulfuric_acid = new ExtendedFluidType("sulfuric_acid",0xB0AA64, solution.descriptionId("Sulfuric Acid"), ExtendedProperties.of().pfr(3,0,2).traits(new FT_Corrosive(50), LIQUID));
    private static final ExtendedFluidType steam = new ExtendedFluidType("steam",0xe5e5e5, solution.temperature(373), ExtendedProperties.of().pfr(3,0,0).traits(GASEOUS, UNSIPHONABLE));
    private static final ExtendedFluidType hotsteam = new ExtendedFluidType("hot_steam",0xE7D6D6, solution.temperature(573), ExtendedProperties.of().pfr(4,0,0).traits(GASEOUS, UNSIPHONABLE));
    private static final ExtendedFluidType superhotsteam = new ExtendedFluidType("superhot_steam",0xE7B7B7, solution.temperature(723), ExtendedProperties.of().pfr(4,0,0).traits(GASEOUS, UNSIPHONABLE));
    private static final ExtendedFluidType ultrahotsteam = new ExtendedFluidType("ultrahot_steam",0xE39393, solution.temperature(873), ExtendedProperties.of().pfr(4,0,0).traits(GASEOUS, UNSIPHONABLE));
    private static final ExtendedFluidType carbon_dioxide = new ExtendedFluidType("carbon_dioxide", 0xb0b0b0, solution.descriptionId("Carbon Dioxide"), ExtendedProperties.of().pfr(0,0,0).traits(GASEOUS, UNSIPHONABLE));
    private static final ExtendedFluidType coolant_hot = new ExtendedFluidType("coolant_hot",0x99525E, solution, ExtendedProperties.of().pfr(1,0,0).traits(LIQUID));
    private static final ExtendedFluidType coolant = new ExtendedFluidType("coolant",0xd8fcff, solution, ExtendedProperties.of().pfr(1,0,0).traits(LIQUID));
    private static final ExtendedFluidType hydrogen = new ExtendedFluidType("hydrogen",0x4286f4, solution.descriptionId("Hydrogen"),ExtendedProperties.of().pfr(3,4,0).traits(GASEOUS));
    private static final ExtendedFluidType deuterium = new ExtendedFluidType("deuterium",0x2f6bff, solution.descriptionId("Deuterium"),ExtendedProperties.of().pfr(3,4,0).traits(GASEOUS));
    private static final ExtendedFluidType tritium = new ExtendedFluidType("tritium",0x0b2a86, solution.descriptionId("Tritium"),ExtendedProperties.of().pfr(3,4,0).traits(GASEOUS));
    private static final ExtendedFluidType helium3 = new ExtendedFluidType("helium3",0xfff0c4, solution.descriptionId("Helium-3"),ExtendedProperties.of().pfr(2,2,0).traits(GASEOUS));
    private static final ExtendedFluidType helium4 = new ExtendedFluidType("helium4",0xffb480, solution.descriptionId("Helium-4"),ExtendedProperties.of().pfr(2,2,0).traits(GASEOUS));
    private static final ExtendedFluidType oxygen = new ExtendedFluidType("oxygen",0xb4e2ff, solution.descriptionId("Oxygen"),ExtendedProperties.of().pfr(2,1,0).traits(GASEOUS));
    private static final ExtendedFluidType chlorine = new ExtendedFluidType("chlorine",0xdae598, solution.descriptionId("Chlorine"),ExtendedProperties.of().pfr(2,1,0).traits(GASEOUS));
    private static final ExtendedFluidType diesel = new ExtendedFluidType("diesel", 0xf2eed5, solution.descriptionId("Diesel"), ExtendedProperties.of().pfr(1, 2, 0));
    private static final ExtendedFluidType oil = new ExtendedFluidType("oil", 0x1d150d, solution.descriptionId("Crude Oil"), ExtendedProperties.of().pfr(1, 2, 0).traits(LIQUID, VISCOUS));
    private static final ExtendedFluidType crack_oil = new ExtendedFluidType("crack_oil", 0x2b1a10, solution.descriptionId("Cracked Oil"), ExtendedProperties.of().pfr(1, 3, 0).traits(LIQUID, VISCOUS));
    private static final ExtendedFluidType bitumen = new ExtendedFluidType("bitumen", 0x150f0b, solution.descriptionId("Bitumen"), ExtendedProperties.of().pfr(1, 3, 0).traits(LIQUID, VISCOUS));
    private static final ExtendedFluidType smear = new ExtendedFluidType("smear", 0x402213, solution.descriptionId("Heavy Residue"), ExtendedProperties.of().pfr(1, 2, 0).traits(LIQUID, VISCOUS));
    private static final ExtendedFluidType naphtha = new ExtendedFluidType("naphtha", 0xfff1b5, solution.descriptionId("Naphtha"), ExtendedProperties.of().pfr(1, 1, 0));
    private static final ExtendedFluidType petroleum = new ExtendedFluidType("petroleum", 0x2e2e2e, solution.descriptionId("Petroleum"), ExtendedProperties.of().pfr(1, 3, 0));
    private static final ExtendedFluidType aromatics = new ExtendedFluidType("aromatics", 0xb04b8e, solution.descriptionId("Aromatics"), ExtendedProperties.of().pfr(2, 2, 1));
    private static final ExtendedFluidType unsaturateds = new ExtendedFluidType("unsaturateds", 0xffb347, solution.descriptionId("Unsaturateds"), ExtendedProperties.of().pfr(2, 1, 1));
    private static final ExtendedFluidType refinery_gas = new ExtendedFluidType("refinery_gas", 0xffd966, solution.descriptionId("Refinery Gas"), ExtendedProperties.of().pfr(1, 2, 0).traits(GASEOUS));
    private static final ExtendedFluidType diesel_crack = new ExtendedFluidType("diesel_crack", 0xe5d4ab, solution.descriptionId("Cracked Diesel"), ExtendedProperties.of().pfr(1, 2, 0));
    private static final ExtendedFluidType kerosene = new ExtendedFluidType("kerosene", 0xf6f2d9, solution.descriptionId("Kerosene"), ExtendedProperties.of().pfr(1, 1, 0));
    private static final ExtendedFluidType wood_oil = new ExtendedFluidType("wood_oil", 0x2f2519, solution.descriptionId("Wood Oil"), ExtendedProperties.of().pfr(1, 1, 0).traits(LIQUID, VISCOUS));
    private static final ExtendedFluidType heating_oil = new ExtendedFluidType("heating_oil", 0x8c6b2b, solution.descriptionId("Heating Oil"), ExtendedProperties.of().pfr(1, 2, 0));
    private static final ExtendedFluidType heating_oil_vacuum = new ExtendedFluidType("heating_oil_vacuum", 0xa37932, solution.descriptionId("Vacuum Heating Oil"), ExtendedProperties.of().pfr(1, 2, 0));
    private static final ExtendedFluidType reform_gas = new ExtendedFluidType("reform_gas", 0xfceea1, solution.descriptionId("Reform Gas"), ExtendedProperties.of().pfr(1, 1, 1).traits(GASEOUS));
    private static final ExtendedFluidType reformate = new ExtendedFluidType("reformate", 0xe0d342, solution.descriptionId("Reformate"), ExtendedProperties.of().pfr(1, 1, 0));
    private static final ExtendedFluidType biogas = new ExtendedFluidType("biogas", 0x7ed691, solution.descriptionId("Biogas"), ExtendedProperties.of().pfr(1, 1, 0).traits(GASEOUS));
    private static final ExtendedFluidType spent_steam = new ExtendedFluidType("spent_steam", 0xc9c9c9, solution.descriptionId("Spent Steam"), ExtendedProperties.of().pfr(0,0,0).traits(GASEOUS, UNSIPHONABLE));
    private static final ExtendedFluidType smoke = new ExtendedFluidType("smoke", 0x808080, solution.descriptionId("Smoke"), ExtendedProperties.of().pfr(0,0,0).traits(GASEOUS, NOID, NOCON));
