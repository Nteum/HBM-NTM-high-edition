...
//        //矿物放置
//        PlacementUtils.register(context, URANIUM_ORE_OVERWORLD, holdergetter.getOrThrow(HBMConfigFeatures.URANIUM_ORE_OVERWORLD),
//                commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-64),VerticalAnchor.aboveBottom(30))));
//        //洞穴放置
//        PlacementUtils.register(context, ORE_SPHERE_OVERWORLD, holdergetter.getOrThrow(HBMConfigFeatures.ORE_SPHERE_OVERWORLD),
...
//        //基岩矿石生成
//        PlacementUtils.register(context, BEDROCK_ORE_OVERWORLD, holdergetter.getOrThrow(HBMConfigFeatures.BEDROCK_ORE_OVERWORLD),RarityFilter.onAverageOnceEvery(1));
//        // 异虫巢
//        PlacementUtils.register(context, GLYPHID_HIVE, holdergetter.getOrThrow(HBMConfigFeatures.GLYPHID_HIVE) ,RarityFilter.onAverageOnceEvery(20), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome());
//        // 陨石坑放置
//        PlacementUtils.register(context, METE_CREATOR_MOON, holdergetter.getOrThrow(HBMConfigFeatures.METE_CREATOR_MOON), RarityFilter.onAverageOnceEvery(50));
//    }
//
