...
public class ModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MISSILE = CREATIVE_MODE_TABS.register("hbm_missiles", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_MISSILE.key())).icon(() -> HBMItems.MISSILE_NUCLEAR.get().getDefaultInstance()).build());
