...
public class ModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> BLOCKS = CREATIVE_MODE_TABS.register("hbm_blocks", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_BLOCKS.key())).icon(() -> ModBlocks.Ores.ORE_URANIUM.get().asItem().getDefaultInstance()).build());
    public static final RegistryObject<CreativeModeTab> MACHINE = CREATIVE_MODE_TABS.register("hbm_machine", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_MACHINE.key())).icon(() -> ModBlocks.Machine.PWR_CONTROLLER.get().asItem().getDefaultInstance()).build());
    public static final RegistryObject<CreativeModeTab> NUKE = CREATIVE_MODE_TABS.register("hbm_nuke", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_NUKE.key())).icon(() -> ModBlocks.Nuke.BOMB_FAT_MAN.get().asItem().getDefaultInstance()).build());
