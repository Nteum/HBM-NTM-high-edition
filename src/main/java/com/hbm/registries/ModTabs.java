...
public class ModTabs {
    ...
    private static void addToolItems(CreativeModeTab.Output output) {
        ...
        output.accept(HBMtools.GEIGER_COUNTER.get());
        output.accept(HBMtools.BUILD_WAND.get());
        output.accept(HBMtools.DEBUG_WAND.get());
        output.accept(HBMtools.DESIGNATOR.get());
        output.accept(HBMtools.RBMK_TOOL.get());
        output.accept(HBMtools.DOSIMETER.get());
        output.accept(HBMtools.DIGAMMA_DIAGNOSTIC.get());
        output.accept(HBMtools.POLLUTION_DETECTOR.get());
        output.accept(HBMtools.ORE_SCANNER.get());
        output.accept(HBMItems.SCREWDRIVER.get());
        output.accept(HBMItems.reacher.get());
    }
    ...
    private static void addRBMKItems(CreativeModeTab.Output output) {
        ...
        output.accept(HBMItems.rbmk_fuel_base.get());
        output.accept(HBMItems.rbmk_fuel_lea.get());
        output.accept(HBMItems.rbmk_fuel_leaus.get());
        output.accept(HBMItems.rbmk_fuel_lep.get());
        output.accept(HBMItems.rbmk_fuel_les.get());
        output.accept(HBMItems.rbmk_fuel_mea.get());
        output.accept(HBMItems.rbmk_fuel_men.get());
        output.accept(HBMItems.rbmk_fuel_mep.get());
        output.accept(HBMItems.rbmk_fuel_mes.get());
        output.accept(HBMItems.rbmk_fuel_meu.get());
        output.accept(HBMItems.rbmk_fuel_ueu.get());
        output.accept(HBMItems.rbmk_fuel_mox.get());
        output.accept(HBMItems.rbmk_fuel_heu233.get());
        output.accept(HBMItems.rbmk_fuel_heu235.get());
        output.accept(HBMItems.rbmk_fuel_heaus.get());
        output.accept(HBMItems.rbmk_fuel_hea241.get());
        output.accept(HBMItems.rbmk_fuel_hea242.get());
        output.accept(HBMItems.rbmk_fuel_hen.get());
        output.accept(HBMItems.rbmk_fuel_hep.get());
        output.accept(HBMItems.rbmk_fuel_hep241.get());
        output.accept(HBMItems.rbmk_fuel_hes.get());
        output.accept(HBMItems.rbmk_fuel_thmeu.get());
        output.accept(HBMItems.rbmk_fuel_drx.get());
        output.accept(HBMItems.rbmk_fuel_flashlead.get());
        output.accept(HBMItems.rbmk_fuel_balefire.get());
        output.accept(HBMItems.rbmk_fuel_balefire_gold.get());
        output.accept(HBMItems.rbmk_fuel_po210be.get());
        output.accept(HBMItems.rbmk_fuel_pu238be.get());
        output.accept(HBMItems.rbmk_fuel_ra226be.get());
        output.accept(HBMItems.rbmk_fuel_zfb_base.get());
        output.accept(HBMItems.rbmk_fuel_zfb_bismuth.get());
        output.accept(HBMItems.rbmk_fuel_zfb_pu241.get());
        output.accept(HBMItems.rbmk_fuel_zfb_am_mix.get());
        output.accept(HBMItems.rbmk_fuel_test.get());
