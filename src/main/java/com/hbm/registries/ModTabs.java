...
public class ModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> CONTROL = CREATIVE_MODE_TABS.register("hbm_control", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_CONTROL.key())).icon(() -> ModItems.RTG_UNIT.get().getDefaultInstance()).build());
    ...
    public static final RegistryObject<CreativeModeTab> MACHINE = CREATIVE_MODE_TABS.register("hbm_machines", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_MACHINE.key())).icon(() -> Blocks.DIRT.asItem().getDefaultInstance()).build());
    ...
    public static final RegistryObject<CreativeModeTab> MISSILE = CREATIVE_MODE_TABS.register("hbm_missiles", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_MISSILE.key())).icon(() -> ModItems.MISSILE_NUCLEAR.get().getDefaultInstance()).build());
    public static final RegistryObject<CreativeModeTab> WEAPON = CREATIVE_MODE_TABS.register("hbm_weapons", () -> CreativeModeTab.builder().title(Component.translatable(HBMLang.HBM_WEAPON.key())).icon(Items.WOODEN_SWORD::getDefaultInstance).build());
