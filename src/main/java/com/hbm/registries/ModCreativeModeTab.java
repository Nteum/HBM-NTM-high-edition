...
public class ModCreativeModeTab {
    ...
    public static final RegistryObject<CreativeModeTab> HBM_ITEM = CREATIVE_MODE_TABS.register("hbm_item",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        for (com.hbm.reactor.pwr.PWRFuelType type : com.hbm.reactor.pwr.PWRFuelType.values()) {
                            ...
                            output.accept(
                                    com.hbm.item.pwr.ItemPWRFuel.createStack(HBMItems.pwr_fuel_depleted.get(), type));
                        }
                        ...
                        for (com.hbm.item.research.ItemBreedingRod.RodType type : com.hbm.item.research.ItemBreedingRod.RodType
                                .values()) {
                            output.accept(com.hbm.item.research.ItemBreedingRod
                                    .createStack(com.hbm.item.research.ItemBreedingRod.RodForm.SINGLE, type));
                            output.accept(com.hbm.item.research.ItemBreedingRod
                                    .createStack(com.hbm.item.research.ItemBreedingRod.RodForm.DUAL, type));
                            output.accept(com.hbm.item.research.ItemBreedingRod
                                    .createStack(com.hbm.item.research.ItemBreedingRod.RodForm.QUAD, type));
                        }

                        HBMComponent.creativeTab(output);
                    }).build());
    public static final RegistryObject<CreativeModeTab> HBM_BLOCK = CREATIVE_MODE_TABS.register("hbm_block",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> HBM_MACHINE = CREATIVE_MODE_TABS.register("hbm_machine",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> HBM_TOOL = CREATIVE_MODE_TABS.register("hbm_weapon",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> HBM_EQUIPMENT = CREATIVE_MODE_TABS.register("hbm_equipment",
            () -> CreativeModeTab.builder()
    ...
    public static final RegistryObject<CreativeModeTab> HBM_MISSILE = CREATIVE_MODE_TABS.register("hbm_missile",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable(HBMLang.ITEMGROUP_BLOCK.key()))
    ...
    public static void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            ...
            event.getEntries().put(new ItemStack(HBMWeapon.MP_WARHEAD_15_BALEFIRE.get()),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().put(new ItemStack(HBMMachine.LAUNCH_PAD.get()),
                    CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            // event.getEntries().put(new ItemStack(HBMtools.DESIGNATOR.get()),
            // CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
    }
