...
public class ForgeEnergyIntegration implements IEnergyStorage {
    ...
    public int receiveEnergy(int maxReceive, boolean simulate) {
        ...
        return Integer.parseInt(Long.toString(inserted));
    }
    ...
    public int extractEnergy(int maxExtract, boolean simulate) {
        ...
        return Integer.parseInt(Long.toString(extracted));
    }
    ...
    public int getEnergyStored() {
        ...
        for (int container = 0, containers = handler.getEnergyContainerCount(); container < containers; container++) {
            int total = Integer.parseInt(Long.toString(handler.getEnergy(container)));
    ...
    public int getMaxEnergyStored() {
        int maxEnergy = 0;
        for (int container = 0, containers = handler.getEnergyContainerCount(); container < containers; container++) {
            int max = Integer.parseInt(Long.toString(handler.getMaxEnergy(container)));
    ...
    public boolean canExtract() {
        ...
        if (!(handler.extractEnergy(1L, Action.SIMULATE)==0)) {
            return true;
        }
    ...
    public boolean canReceive() {
        ...
        if (handler.insertEnergy(1L, Action.SIMULATE)<1L) {
            return true;
        }
