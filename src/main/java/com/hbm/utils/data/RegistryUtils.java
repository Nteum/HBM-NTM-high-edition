...
public class RegistryUtils {
    ...
    // 获取description id的方法，仅仅是本mod习惯采用的格式，未必适合其他mod
    public static String getDescriptionId(ResourceKey<?> resourceKey){
        return resourceKey.registry().getPath().toLowerCase() + "." + resourceKey.location().getNamespace() + "." + resourceKey.location().getPath();
    }
}