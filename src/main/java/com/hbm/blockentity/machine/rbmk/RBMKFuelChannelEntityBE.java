 ...
 */
public class RBMKFuelChannelEntityBE extends BaseMachineBE {
    ...
    public RBMKFuelChannelEntityBE(BlockPos pos, BlockState state) {
    ...
    public void serverTick() {
        ...
        final RBMKBaseEntityBE baseEntity = level.getBlockEntity(corePos) instanceof RBMKBaseEntityBE base ? base : null;
    ...
    private void updateClientData(@Nullable RBMKColumnState column, @Nullable RBMKBaseEntityBE base,
