...
public class RBMKRadioControllerEntityBE extends BEUpdateable implements MenuProvider {
    ...
    public RBMKRadioControllerEntityBE(BlockPos pos, BlockState state) {
    ...
    private void applySignal(String payload) {
        ...
        RBMKControlRodEntityBE rod = resolveTargetControlRod();
    ...
    @Nullable
    private RBMKControlRodEntityBE resolveTargetControlRod() {
        ...
        if (level.getBlockEntity(target) instanceof RBMKControlRodEntityBE rod) {
            return rod;
        }
        if (level.getBlockEntity(target.above()) instanceof RBMKControlRodEntityBE rodAbove) {
            return rodAbove;
        }
        return null;
    }
