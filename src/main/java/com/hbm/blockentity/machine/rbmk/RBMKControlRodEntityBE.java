...
public class RBMKControlRodEntityBE extends BaseMachineBE {
    ...
    public RBMKControlRodEntityBE(BlockPos pos, BlockState state) {
    ...
    public void serverTick() {
        ...
        RBMKBaseEntityBE base = level.getBlockEntity(corePos) instanceof RBMKBaseEntityBE rbmkBase ? rbmkBase : null;
    ...
    protected void updateClientData(@Nullable RBMKColumnState column, @Nullable RBMKBaseEntityBE base,
