 ...
 */
public class RBMKBaseEntityBE extends DummyableBE {
    ...
    public RBMKBaseEntityBE(BlockPos pPos, BlockState pState) {
    ...
    public void triggerAz5() {
        ...
        if (level.getBlockEntity(controlPos) instanceof RBMKControlRodEntityBE controlRodEntity) {
