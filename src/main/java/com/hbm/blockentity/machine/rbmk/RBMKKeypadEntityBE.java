 ...
 * slice bounded.
 */
public class RBMKKeypadEntityBE extends BEUpdateable implements RBMKLinkable, MenuProvider {
    ...
    public RBMKKeypadEntityBE(BlockPos pos, BlockState state) {
    ...
    public void trigger(int index) {
        ...
        if (!sentByRadio && linkedColumn != null
                && serverLevel.getBlockEntity(linkedColumn.above()) instanceof RBMKControlRodEntityBE controlRod) {
