...
public class PressEntityBE extends BEMachineBase {
    ...
    public PressEntityBE(BlockPos pPos, BlockState pBlockState) {
        super(pPos, pBlockState);
        this.addCapability(ForgeCapabilities.ITEM_HANDLER, items);
    }
