...
public class ElectricFurnaceEntityBE extends BaseMachineBE implements MenuProvider, IUpgradeInfoProvider {
    public int progress;
    ...
    private final com.hbm.core.contents.upgrade.MachineUpgradeHandler upgradeHandler = new com.hbm.core.contents.upgrade.MachineUpgradeHandler(this).speed(0.25).power(0.15);
    ...
    public ElectricFurnaceEntityBE(BlockPos pPos, BlockState pBlockState) {
    ...
    protected void onUpdateServer() {
        ...
        if(!this.getLevel().isClientSide()) {
            ...
            this.consumption = (int) (50 * powerMult);
            this.maxProgress = (int) Math.max(1, 100 / speedMult);
