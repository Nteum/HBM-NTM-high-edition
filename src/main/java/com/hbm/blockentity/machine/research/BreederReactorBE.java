...
public class BreederReactorBE extends DummyableBE implements MenuProvider {
    ...
    public BreederReactorBE(BlockPos pos, BlockState state) {
        super(HBMTiles.BREEDER_REACTOR_ENTITY.get(), pos, state);
        ...
        for (Direction dir : Direction.Plane.HORIZONTAL) {
            ...
            if (neighborState.getBlock() == ModBlocks.machine_research_reactor.get()) {
                ...
                if (corePos != null) {
                    ...
                    if (blockEntity instanceof ResearchReactorBE reactor) {
