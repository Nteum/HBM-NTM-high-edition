...
public class PipeEntityBEPipeBase extends BEPipeBase {
    public FluidBackupSystem.FluidNetwork network;
    int oldColor = -1;
    @OnlyIn(Dist.CLIENT) private Fluid clientFluid = Fluids.EMPTY;

    public PipeEntityBEPipeBase(BlockPos pPos, BlockState pBlockState) {
