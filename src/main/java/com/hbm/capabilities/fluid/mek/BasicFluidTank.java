...
import com.hbm.api.function.ConstantPredicates;
import com.hbm.utils.NBTUtils;
import com.hbm.utils.RegistryUtils;
...
public class BasicFluidTank implements IExtendedFluidTank {
    ...
    public CompoundTag serializeNBT() {
        ...
        if (!isEmpty()) {
            nbt.put(HBMKey.STORED, stored.writeToNBT(new CompoundTag()));
        }
        return nbt;
    }
    ...
    public void deserializeNBT(CompoundTag nbt) {
        NBTUtils.setFluidStackIfPresent(nbt, HBMKey.STORED, this::setStackUnchecked);
    }
}