package com.hbm.modsetting.badthing.hazard;

import com.hbm.Untested;
import com.hbm.modsetting.badthing.hazard.modifier.HazardModifier;
import com.hbm.modsetting.badthing.hazard.transformers.HazardTransformerBase;
import com.hbm.modsetting.badthing.hazard.type.HazardTypeBase;
...
//		}
	...
	public static void updatePlayerInventory(Player player) {
		...
		for (ItemStack stack : player.getInventory().armor) {
			if (stack != null)applyHazards(stack, player);
		}
...
class ComparableStack{
	ComparableStack(Object o){}
	ComparableStack makeSingular(){return null;}
}