...
public class ItemEnergyProxy {
    ...
    public static void setEnergy(ItemStack stack, IHBMEnergy cap){
    ...
    //向电池充电
    public static void charge(ItemStack stack, IHBMEnergy cap){
        if (stack.getItem() instanceof IItemBattery itemBattery
            ...
            long input = cap.extractEnergy(energyProxy.maxReceive);
