...
public class LanguageProvider extends net.minecraftforge.common.data.LanguageProvider {
    ...
    private void addTooltip(){
        ...
        this.add(HBMItems.icf_pellet.get(), "ICF Fuel Pellet");
        this.add(HBMItems.icf_pellet_depleted.get(), "Depleted ICF Fuel Pellet");
        this.add(HBMItems.icf_pellet_empty.get(), "Empty ICF Fuel Pellet");
        this.add(HBMItems.plate_fuel_u233.get(), "U-233 Research Plate");
        this.add(HBMItems.plate_fuel_u235.get(), "U-235 Research Plate");
        this.add(HBMItems.plate_fuel_mox.get(), "MOX Research Plate");
        this.add(HBMItems.plate_fuel_pu239.get(), "Pu-239 Research Plate");
        this.add(HBMItems.plate_fuel_sa326.get(), "SA-326 Research Plate");
        this.add(HBMItems.plate_fuel_ra226be.get(), "Ra-226/Be Source Plate");
        this.add(HBMItems.plate_fuel_pu238be.get(), "Pu-238/Be Source Plate");
        this.add(HBMItems.waste_plate_u233.get(), "Spent U-233 Plate");
        this.add(HBMItems.waste_plate_u235.get(), "Spent U-235 Plate");
        this.add(HBMItems.waste_plate_mox.get(), "Spent MOX Plate");
        this.add(HBMItems.waste_plate_pu239.get(), "Spent Pu-239 Plate");
        this.add(HBMItems.waste_plate_sa326.get(), "Spent SA-326 Plate");
        this.add(HBMItems.waste_plate_ra226be.get(), "Spent Ra-226/Be Plate");
        this.add(HBMItems.waste_plate_pu238be.get(), "Spent Pu-238/Be Plate");
        this.add(HBMItems.WOOD_ASH_POWDER.get(), "Wood Ash Powder");
        this.add(HBMItems.rod_breeder_single.get(), "Breeder Rod");
        this.add(HBMItems.rod_breeder_dual.get(), "Dual Breeder Rod");
        this.add(HBMItems.rod_breeder_quad.get(), "Quad Breeder Rod");
        ...
        this.add("container.hbm.icf", "ICF Reactor");
        this.add("container.hbm.icf_controller", "ICF Laser Controller");
        this.add("container.hbm.icf_press", "ICF Fuel Press");
        this.add("container.hbm.research_reactor", "Research Reactor");
        this.add("container.hbm.reactor_breeder", "Breeder Reactor");
