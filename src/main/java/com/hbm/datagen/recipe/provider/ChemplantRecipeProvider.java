...
public class ChemplantRecipeProvider implements ISubRecipeProvider {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer) {
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"hydrogen")).duration(20).requireItems(new ItemStack(Items.COAL,1)).requireFluids(new FluidStack(Fluids.WATER, 8000))
                .resultFluids(new FluidStack(HBMFluids.HYDROGEN.source().get(), 500)).save(consumer);
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"oxygen")).duration(20).requireFluids(new FluidStack(Fluids.WATER, 8000))
                .resultFluids(new FluidStack(HBMFluids.OXYGEN.source().get(), 400)).save(consumer);
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"deuterium")).duration(60)
                .requireItems(new ItemStack(ModItems.DEUTERIUM_FILTER.get()))
                .requireFluids(new FluidStack(HBMFluids.HYDROGEN.source().get(), 4000))
                .resultFluids(new FluidStack(HBMFluids.DEUTERIUM.source().get(), 250)).save(consumer);
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"tritium")).duration(80)
                .requireItems(new ItemStack(ModItems.TRITIUM_DEUTERIUM_CAKE.get()))
                .requireFluids(new FluidStack(HBMFluids.DEUTERIUM.source().get(), 2000))
                .resultFluids(new FluidStack(HBMFluids.TRITIUM.source().get(), 250)).save(consumer);
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"helium3")).duration(100)
                ...
                .resultFluids(new FluidStack(HBMFluids.HELIUM3.source().get(), 125)).save(consumer);
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"helium4")).duration(60)
                .requireFluids(new FluidStack(HBMFluids.HELIUM3.source().get(), 500), new FluidStack(HBMFluids.HYDROGEN.source().get(), 500))
                .resultFluids(new FluidStack(HBMFluids.HELIUM4.source().get(), 500)).save(consumer);
        ItemFluidRecipeBuilder.of(HBM.rl(ROOT+"chlorine")).duration(40)
                ...
                .resultFluids(new FluidStack(HBMFluids.CHLORINE.source().get(), 250)).save(consumer);
    }
}
