...
import com.hbm.item.tool.HandDrillItem;
...
//    ingot_chainsteel = new ItemHot(100).setUnlocalizedName("ingot_chainsteel").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ingot_chainsteel");
    ...
    public static final RegistryObject<Item> COKE_COAL = parts("coke_coal", ()->new ItemFuel(new Item.Properties(), 200 * 16), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> COKE_LIGNITE = parts("coke_lignite", ()->new ItemFuel(new Item.Properties(), 200 * 16), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> COKE_PETROLEUM = parts("coke_petroleum", ()->new ItemFuel(new Item.Properties(), 200 * 16), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    ...
    public static final RegistryObject<Item> POWDER_LIGNITE = parts("powder_lignite", ()->new ItemFuel(new Item.Properties(), 1200), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
...
//    powder_schrabidate = new ItemCustomLore().setRarity(EnumRarity.rare).setUnlocalizedName("powder_schrabidate").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_schrabidate");
    ...
    public static final RegistryObject<Item> POWDER_COAL = parts("powder_coal", ()->new ItemFuel(new Item.Properties(), 200 * 8), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
...
//    powder_boron = new ItemCustomLore().setRarity(EnumRarity.epic).setUnlocalizedName("powder_boron").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":powder_boron");
    ...
    public static final RegistryObject<Item> POWDER_SAWDUST = parts("powder_sawdust", ()->new ItemFuel(new Item.Properties(), 200 / 2), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
...
//    chunk_ore = new ItemEnumMulti(EnumChunkType.class, true, true).setUnlocalizedName("chunk_ore").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final RegistryObject<Item> BIOMASS = parts("biomass", ()->new ItemFuel(new Item.Properties(), 200 * 2), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
...
//    public static final RegistryObject<Item> DESIGNATOR = ITEMS.register("designator",()->new ItemDesignator(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> icf_pellet = control("icf_pellet", () -> new ItemICFPellet(new Item.Properties()), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> icf_pellet_depleted = control("icf_pellet_depleted", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> icf_pellet_empty = control("icf_pellet_empty", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_u233 = control("plate_fuel_u233", () -> new ItemResearchFuelPlate(new Item.Properties(), 2_200_000, ItemResearchFuelPlate.FunctionType.SQUARE_ROOT, 50), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_u235 = control("plate_fuel_u235", () -> new ItemResearchFuelPlate(new Item.Properties(), 2_200_000, ItemResearchFuelPlate.FunctionType.SQUARE_ROOT, 40), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_mox = control("plate_fuel_mox", () -> new ItemResearchFuelPlate(new Item.Properties(), 2_400_000, ItemResearchFuelPlate.FunctionType.LOGARITHM, 50), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_pu239 = control("plate_fuel_pu239", () -> new ItemResearchFuelPlate(new Item.Properties(), 2_000_000, ItemResearchFuelPlate.FunctionType.NEGATIVE_QUADRATIC, 50), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_sa326 = control("plate_fuel_sa326", () -> new ItemResearchFuelPlate(new Item.Properties(), 2_000_000, ItemResearchFuelPlate.FunctionType.LINEAR, 80), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_ra226be = control("plate_fuel_ra226be", () -> new ItemResearchFuelPlate(new Item.Properties(), 1_300_000, ItemResearchFuelPlate.FunctionType.PASSIVE, 30), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> plate_fuel_pu238be = control("plate_fuel_pu238be", () -> new ItemResearchFuelPlate(new Item.Properties(), 1_000_000, ItemResearchFuelPlate.FunctionType.PASSIVE, 50), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_u233 = control("waste_plate_u233", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_u235 = control("waste_plate_u235", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_mox = control("waste_plate_mox", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_pu239 = control("waste_plate_pu239", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_sa326 = control("waste_plate_sa326", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_ra226be = control("waste_plate_ra226be", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> waste_plate_pu238be = control("waste_plate_pu238be", () -> new Item(new Item.Properties().stacksTo(1)), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    ...
    public static final RegistryObject<Item> rod_empty = control("rod_empty", () -> new Item(new Item.Properties()), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> rod_dual_empty = control("rod_dual_empty", () -> new Item(new Item.Properties()), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> rod_quad_empty = control("rod_quad_empty", () -> new Item(new Item.Properties()), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> rod_breeder_single = control("rod_breeder_single", () -> new ItemBreedingRod(new Item.Properties(), ItemBreedingRod.RodForm.SINGLE), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> rod_breeder_dual = control("rod_breeder_dual", () -> new ItemBreedingRod(new Item.Properties(), ItemBreedingRod.RodForm.DUAL), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    public static final RegistryObject<Item> rod_breeder_quad = control("rod_breeder_quad", () -> new ItemBreedingRod(new Item.Properties(), ItemBreedingRod.RodForm.QUAD), HBMKey.ORDERLY_GEN_EXCEPT_FIRST);
    ...
    public static RegistryObject<Item> machine(final String name, final Supplier<? extends Item> sup){
        return add(name, sup, ModTabs.MACHINE.getKey(), HBMKey.REVERSE_GEN);
    }
