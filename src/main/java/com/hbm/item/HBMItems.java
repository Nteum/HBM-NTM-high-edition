...
public class HBMItems {
    ...
    public static final RegistryObject<Item> REDSTONE_SWORD = new ItemBuilder("redstone_sword", ()->new RedstoneSword(Tiers.STONE, 3, -2.4F, new Item.Properties())).tab(CreativeModeTabs.COMBAT).build();
    public static final RegistryObject<Item> BIG_SWORD = new ItemBuilder("big_sword", ()->new BigSword(Tiers.GOLD, 3, -2.4F, new Item.Properties())).tab(CreativeModeTabs.COMBAT).build();
    /* material */
