...
/**
 * Flat Unsafe wrapper using MethodHandles over jdk.internal.misc.Unsafe.
 *
 * @author mlbv
 */
@SuppressCheckedExceptions
public final class InternalUnsafeWrapper {

    static final int MAJOR_VERSION = Runtime.version().feature();
