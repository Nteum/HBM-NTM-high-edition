...
public class ModFluidTypes {
    //流体类型注册器
    public static final DeferredRegister<FluidType> FLUID_TYPES = DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, HBMxx.MODID);
    //原版水的静止和流动贴图
    ...
    public static final ResourceLocation SULFURIC_STILL_TEX = new ResourceLocation(HBMxx.MODID,"block/fluid/sulfuric_acid_still");
    public static final ResourceLocation SULFURIC_FLOWING_TEX = new ResourceLocation(HBMxx.MODID,"block/fluid/sulfuric_acid_flowing");
    public static final ResourceLocation IRRADIATED_WATER_STILL = new ResourceLocation(HBMxx.MODID,"block/fluid/irradiated_water_still");
    public static final ResourceLocation IRRADIATED_WATER_FLOW = new ResourceLocation(HBMxx.MODID,"block/fluid/irradiated_water_flow");
    public static final ResourceLocation IRRADIATED_POLLUTED_STILL = new ResourceLocation(HBMxx.MODID,"block/fluid/irradiated_polluted_still");
    public static final ResourceLocation IRRADIATED_POLLUTED_FLOW = new ResourceLocation(HBMxx.MODID,"block/fluid/irradiated_polluted_flow");
    //液体属性
    ...
    public static final RegistryObject<FluidType> SULFURIC_ACID = FLUID_TYPES.register("sulfuric_acid",
            ()->new BaseFluidType(SULFURIC_STILL_TEX,SULFURIC_FLOWING_TEX,WATER_OVERLAY,0xA1E038D0,new Vector3f(224f / 255f, 56f / 255f, 208f / 255f),defaultProperties));//0x96C074
