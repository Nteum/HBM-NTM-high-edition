...
public class ClientConfig extends RunningConfig {
	...
	public static ConfigWrapper<Boolean> RENDER_REEDS =						new ConfigWrapper(!HBM.isLoad(Compat.MOD_ANG));
	...
	public static ConfigWrapper<Boolean> DEBUG_TAG_OVERLAY =				new ConfigWrapper(true);
	...
	private static void initDefaults() {
		...
		configMap.put("DEBUG_TAG_OVERLAY", DEBUG_TAG_OVERLAY);
	}
